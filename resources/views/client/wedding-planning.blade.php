...
@section('title', $metaTitle ?? 'QuickDials | A Local Search Engine for wedding')
...
@section('og_image', !empty('popular/Flower_Decoration.jpg')
    ? asset('popular/Flower_Decoration.jpg')
    ...
    <div class="relative z-10 w-full px-6 md:px-14 lg:px-20 pt-10 md:pt-16 lg:pt-20 pb-10">
        ...
        <h2 class="reveal serif font-bold leading-none mb-4 md:mb-5 d-2 gradient-headline"
          ...
          <div itemscope itemtype="https://schema.org/Product" class="space-y-2">    
            <div itemprop="name">
                <h1 class="text-lg font-bold text-white leading-tight">Where Every Wedding Planning</h1>
            </div>                           
            <div itemprop="aggregateRating"
                ...
                <span class="text-white">ratings</span></span>
            </div>
        </div> 
    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div class="reveal mb-6 md:mb-10">
            ...
            <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
                ...
                <a href="{{ route('showCity','faridabad') }}" class="self-start md:self-auto border border-red-200 text-red-700
    ...
    <div class="relative z-10">
        <div class="container mx-auto px-4 md:px-6 mb-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <a href="{{ route('showCity','faridabad') }}" class="reveal-r text-red-700 font-medium hover:underline flex items-center gap-1 text-sm">
                    View all venues →
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 md:px-6">
        ...
        <div class="reveal mb-6 md:mb-10">
            ...
            <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
                ...
                <a href="{{ route('showCity','faridabad') }}" class="self-start border border-gray-300 text-gray-800 hover:bg-gray-900 hover:text-white
