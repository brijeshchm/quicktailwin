                 ...
                 <div>
                    ...
                    <div class="phone-row">
                        ...
                        <div class="phone-input-wrap">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" style="z-index:1;">
...
<div>
    ...
    <div class="relative" id="popup-city-wrapper">
        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none z-10"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-3.5 h-3.5">
