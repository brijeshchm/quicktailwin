...
<div x-data="spaHub()" x-init="init()" class="bg-white">
    ...
    <main class="pt-[60px]">
        <section id="hero">
            @include('client.spa.components.hero-banner', ['spa' => $spa])
        </section>

        <div class="mx-12 h-px bg-gradient-to-r from-transparent via-stone-200 to-transparent"></div>

        <section id="spa-types">
            @include('client.spa.components.spa-types')
        </section>

        <section id="gallery" class="bg-orange-50">
            @include('client.spa.components.gallery')
        </section>

        <section id="info" class="bg-orange-50">
            @include('client.spa.components.business-info', ['spa' => $spa])
        </section>

        <div class="mx-12 h-px bg-gradient-to-r from-transparent via-stone-200 to-transparent"></div>

        <section id="reviews">
            @include('client.spa.components.reviews')
        </section>
    </main>
