...
@php
/**
 * IMPORTANT: Filtering + pagination happen in the CONTROLLER, not here.
 * $leads     = paginated leads, already filtered by status/archived/favorite
 * $followups = full collection of ALL follow-up records (not paginated)
 *              each row shaped: id, lead_id, notes, outcome, dueAt, done
 * See LeadController@leads for the query.
 */
