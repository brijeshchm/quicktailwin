    ...
    <div class="bg-slate-900 text-white py-12">
        <div class="container mx-auto px-4">
            <div class="flex items-center gap-2 text-slate-400 text-sm mb-3">
                ...
                <span class="text-white">All News</span>
            </div>
            ...
            <div class="flex-1 min-w-0" id="course-area">
                ...
                <div class="flex items-center justify-between mb-5">
                    <p class="text-slate-600 text-sm">
                        <span id="result-count" class="font-bold text-slate-900">{{ count($news) }}</span>
                        courses found
                    </p>
                </div>
                ...
                <div id="grid-view"
                    ...
                    <div class="course-card reveal d-{{ min($i % 6, 5) }} bg-white border border-slate-200
                         ...
                         data-title="{{ strtolower($new['title'] ?? '') }}"
                         data-name="{{ strtolower($new['name'] ?? '') }}"
                         data-slug="{{ $new['child_slug'] ?? '' }}"
                         data-rating="{{ $new['rating'] ?? 0 }}"
                         data-count="{{ $new['ratingcount'] ?? 0 }}">
                        <a href="{{ route('news.details', $new['slug']) }}" class="block h-full flex flex-col">
                            {{-- Card image/header --}}
                    ...
                    <div class="col-span-3 text-center py-16">
                        <p class="text-slate-500 text-lg font-medium">No new available.</p>
                    </div>
                   @endif
                </div>
                ...
                <div id="empty-state" class="hidden text-center py-16">
                    <p class="text-slate-500 text-lg font-medium">No new match your filters.</p>
