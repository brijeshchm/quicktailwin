...
@section('title', 'News | QuickDials - Business, Education & Local Service Insights')
@section('description', 'Explore the QuickDials News for the latest updates, business tips, education guides, career advice, local service insights, digital marketing trends, technology news, and helpful articles to grow your business and stay informed.')
@section('keywords', 'QuickDials News, business News India, local business tips, education articles, career guidance, digital marketing tips, technology news, startup tips, local services News, IT training guides, business growth strategies, online business directory News, QuickDials articles')
@section('content') 
        ...
        <div class="ticker-track">
            ...
            @foreach([$tickerArticles, $tickerArticles] as $group)
                ...
                <span class="inline-flex items-center mr-12">
                    ...
                    <a href="{{ route('news.details', $item['url']) }}"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-8 lg:order-2 space-y-12">
            ...
            <article class="group hero-card rounded-xl overflow-hidden bg-white shadow-sm border border-gray-200 cursor-pointer">
                <a href="{{ route('news.details', $firstNews['url']) }}" class="block">

                    {{-- Thumbnail / gradient fallback --}}
                    <div class="aspect-[2/1] w-full overflow-hidden relative">
                        @if(!empty($firstNews['img']))
                            <div class="image-zoom w-full h-full"
                                 style="background-image: url('{{ $firstNews['img'] }}');
                        ...
                        @else
                            <div class="image-zoom w-f  ull h-full flex items-center justify-center"
                                ...
                                <span class="text-white/20 text-[8rem] font-black select-none leading-none">
                                   {{ strtoupper(substr($firstNews['name'] ?? 'Q', 0, 1)) }}
                                </span>
                            </div>
                        @endif
                    ...
                    <div class="p-6 md:p-8 bg-white">
                        ...
                        @if(!empty($firstNews['excerpt']))
                        <p class="text-slate-500 text-lg mb-6 line-clamp-3">
                            {{ strip_tags($firstNews['excerpt']) }}
                        </p>
                        @endif
            ...
            <div>
                ...
                <div id="articles-container" class="space-y-6">
                    ...
                    <article data-article-index="{{ $index }}"
                        ...
                        <a href="{{ route('news.details', $article['url']) }}" class="contents">
                            {{-- Thumbnail --}}
            ...
            <div class="sticky top-6 space-y-8 max-h-[calc(100vh-3rem)] overflow-y-auto
                ...
                <div class="sidebar-reveal bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="{{ route('news.category', ['url' => Str::slug($cat->name)]) }}"
                ...
                <div class="sidebar-reveal bg-white p-6 rounded-xl border border-gray-200 shadow-sm"
                    ...
                    <div class="space-y-5 mt-2">
                        ...
                        <div class="popular-item">
                            <a href="{{ route('news.details', $article['url']) }}"
