        ...
        <div id="page-wrapper">
           <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-12">
                        <h2><a href="{{url('developer/news/news-list')}}">News Details</a></h2>
                     
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex flex-row-reverse">
                            <div class="page_action">
                                <button type="button" class="btn btn-primary" style="color:#fff;margin-top:20px"><a href="{{url('developer/News/addNews')}}" style="color:#fff"> <i class="fa fa-plus" aria-hidden="true"></i> Add News</a></button>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="section-border">
            ...
            <form class="form-horizontal" method="POST" onsubmit="return newsController.updateNewsMeta(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)">
                {{ csrf_field() }}
...
<div class="form-group">
        ...
        <div class="section-border">
            ...
            <form class="form-horizontal" method="POST" onsubmit="return newsController.updateAboutNews(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)" >
                {{ csrf_field() }}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group text-center">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-btn"></i> Update News 
                        </button>
                    </div>
                </div>
            </form>
        ...
        <div class="section-border">
            <h4>Page Content</h4>
            <form class="form-horizontal" method="POST" onsubmit="return newsController.updatePageContent(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)" >
                {{ csrf_field() }}
  ...
  {{-- ==================== PAGE CONTENT SECTION ==================== --}}
        <div class="section-border">
            <h4>News Image</h4>
            <form class="form-horizontal" method="POST" onsubmit="return newsController.updateNewsImage(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <?php 
                        ...
                        <a href="{{url('developer/news/del_icon/'.$edit_data->id)}}" title="remove"><i class="fa fa-times fa-fw" aria-hidden="true"></i></a>
                ...
                <div class="form-group">
									...
									<div class="col-md-7">
										...
										if(!empty($edit_data->image_banner)){
									 	$bimage = json_decode($edit_data->image_banner);
										$imagev = $bimage->image_banner->src;
										?>
										@if(isset($imagev)&&!empty($imagev))
										<img loading="lazy" src="{{url($imagev)}}" style="height:75px;width:75px;">
										<a href="{{url('developer/news/del_news_banner/'.$edit_data->id)}}" title="remove"><i class="fa fa-times fa-fw" aria-hidden="true"></i></a>
        ...
        <div class="section-border">
            <h4>FAQ Section</h4>
            <form class="form-horizontal" method="POST" onsubmit="return newsController.updateFaqNews(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)">
                {{ csrf_field() }}
