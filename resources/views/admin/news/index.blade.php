...
padding:0px;
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					@if(Request::segment(3)=='editNews' || Request::segment(3)=='addNews'	)
				<div class=" row form-group{{ $errors->has('mode') ? ' has-error' : '' }}">
				@if(Request::segment(3)=='addNews')
				<form method="POST" action="" class="form-horizontal" onsubmit="return newsController.saveNews(this)" enctype="multipart/form-data">
				...
				@endif
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="name" placeholder="Enter News Name" value="{{ old('name',(isset($edit_data)) ? $edit_data->name:"")}}">
							@if ($errors->has('name'))
								<span class="error alert-danger">
                    ...
                    <div class="col-md-8">
						...
						<div class="form-group">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="datatable-news-list">
                                <thead>
                                    <tr>
                                        <th>Name</th>
										<th>Title</th>                                        
